...
<h1>Business & Social Impact ROI</h1>
<h2>From Research to Real-World Value</h2>
...
<div style="background:rgba(59,130,246,0.08);border:1px solid rgba(59,130,246,0.2);border-radius:10px;padding:14px">
  <div class="txt-md" style="color:#3B82F6;font-weight:700;margin-bottom:4px">[1] Health Insurance Pricing</div>
  <div class="txt-xs" style="color:#94A3B8;line-height:1.5;margin-bottom:6px">Dynamic Risk Scoring API for insurers (Prudential, AIA, Manulife)</div>
  <div style="background:rgba(16,185,129,0.1);border-radius:6px;padding:6px 10px">
    <div class="txt-xs" style="color:#10B981;font-weight:600">ROI: 15-25% reduction in Loss Ratio</div>
    <div class="txt-xs" style="color:#64748B;margin-top:2px">Auto-adjust premiums for high-risk zones 3 months ahead</div>
  </div>
</div>

<div style="background:rgba(139,92,246,0.08);border:1px solid rgba(139,92,246,0.2);border-radius:10px;padding:14px">
  <div class="txt-md" style="color:#8B5CF6;font-weight:700;margin-bottom:4px">[2] Pharma Supply Chain</div>
  <div class="txt-xs" style="color:#94A3B8;line-height:1.5;margin-bottom:6px">Inventory Optimization for distributors (Long Chau, Pharmacity)</div>
  <div style="background:rgba(16,185,129,0.1);border-radius:6px;padding:6px 10px">
    <div class="txt-xs" style="color:#10B981;font-weight:600">ROI: 30-40% reduction in expired inventory</div>
    <div class="txt-xs" style="color:#64748B;margin-top:2px">Pre-position medical supplies 1-2 months before outbreaks</div>
  </div>
</div>

<div style="background:rgba(6,182,212,0.08);border:1px solid rgba(6,182,212,0.2);border-radius:10px;padding:14px">
  <div class="txt-md" style="color:#06B6D4;font-weight:700;margin-bottom:4px">[3] Hospital Resource Planning</div>
  <div class="txt-xs" style="color:#94A3B8;line-height:1.5;margin-bottom:6px">ICU/bed capacity forecasting for healthcare networks</div>
  <div style="background:rgba(16,185,129,0.1);border-radius:6px;padding:6px 10px">
    <div class="txt-xs" style="color:#10B981;font-weight:600">ROI: 20-35% improvement in resource allocation</div>
    <div class="txt-xs" style="color:#64748B;margin-top:2px">Reduce overcrowding, optimize staffing costs</div>
  </div>
</div>
...
<h3>Quantum-as-a-Service (QaaS) Model</h3>

<div class="card" style="padding:14px;margin-bottom:10px">
  <div class="txt-md" style="color:#FFFFFF;font-weight:700;margin-bottom:6px">Hybrid Architecture = No Hardware Investment</div>
  <div class="txt-xs" style="color:#64748B;line-height:1.6">Enterprises don't need to buy quantum computers. Our system runs on classical Cloud GPU (AWS/GCP/Azure) and calls Quantum APIs (IBM Quantum, AWS Braket) only for complex embedding tasks.</div>
</div>
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px">
  <div style="background:rgba(16,185,129,0.08);border:1px solid rgba(16,185,129,0.2);border-radius:8px;padding:12px;text-align:center">
    <div style="font-size:28px;font-weight:800;color:#10B981;line-height:1">$0</div>
    <div class="txt-xs" style="color:#64748B;margin-top:4px">Quantum HW Cost</div>
  </div>
  <div style="background:rgba(59,130,246,0.08);border:1px solid rgba(59,130,246,0.2);border-radius:8px;padding:12px;text-align:center">
    <div style="font-size:28px;font-weight:800;color:#3B82F6;line-height:1">100%</div>
    <div class="txt-xs" style="color:#64748B;margin-top:4px">Quantum Benefit</div>
  </div>
</div>
...
<div style="background:rgba(245,158,11,0.08);border:1px solid rgba(245,158,11,0.2);border-radius:10px;padding:14px">
  <div class="txt-sm" style="color:#F59E0B;font-weight:700;margin-bottom:6px">SDG Alignment</div>
  <div style="display:flex;flex-wrap:wrap;gap:6px">
    <span style="background:rgba(16,185,129,0.15);border:1px solid rgba(16,185,129,0.3);padding:4px 10px;border-radius:12px;font-size:10px;color:#10B981">SDG 3: Health</span>
    <span style="background:rgba(59,130,246,0.15);border:1px solid rgba(59,130,246,0.3);padding:4px 10px;border-radius:12px;font-size:10px;color:#3B82F6">SDG 10: Equality</span>
    <span style="background:rgba(139,92,246,0.15);border:1px solid rgba(139,92,246,0.3);padding:4px 10px;border-radius:12px;font-size:10px;color:#8B5CF6">SDG 13: Climate</span>
    <span style="background:rgba(6,182,212,0.15);border:1px solid rgba(6,182,212,0.3);padding:4px 10px;border-radius:12px;font-size:10px;color:#06B6D4">SDG 17: Partnership</span>
  </div>
  <div class="txt-xs" style="color:#64748B;margin-top:8px;line-height:1.5">Proactive disease control reduces healthcare costs for low-income populations. Early warning enables equitable access to medical resources.</div>
</div>
